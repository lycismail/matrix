...
const TrafficLightStyle TrafficLightStyle_MIN = TrafficLightStyle_Unknown;
const TrafficLightStyle TrafficLightStyle_MAX = TrafficLightStyle_Left_And_Return;
...
const TrafficLightStatus TrafficLightStatus_MIN = TrafficLightStatus_Off;
const TrafficLightStatus TrafficLightStatus_MAX = TrafficLightStatus_Other;
...
const TrafficSignType TrafficSignType_MIN = TrSignType_I_Circle;
const TrafficSignType TrafficSignType_MAX = TrSignType_W_Y_Right;
